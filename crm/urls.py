...
urlpatterns = [
    ...
    path("enquiries/<int:enquiry_pk>/create-proposal/", views.proposal_create, name="proposal_create_from_enquiry"),
    path("proposals/<int:pk>/", views.proposal_detail, name="proposal_detail"),
    path("proposals/<int:pk>/builder/", views.proposal_builder, name="proposal_builder"),

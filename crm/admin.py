...
class OrganisationAdmin(ExportCsvMixin, admin.ModelAdmin):
...
class ContactAdmin(ExportCsvMixin, admin.ModelAdmin):
...
class EnquiryAdmin(ExportCsvMixin, admin.ModelAdmin):
...
class ProposalAdmin(ExportCsvMixin, admin.ModelAdmin):
